...
import { addCategorie } from '../../actions/CategorieActions';
...
class CategorieForm extends Component {
  ...
  onSubmit(e) {
    ...
    this.props.addCategorie(newCategorie);
    this.setState({ text: '' });
  }
...
export default connect(mapStateToProps, { addCategorie })(CategorieForm);

...
export const GET_DOCUMENTSS = 'GET_DOCUMENTSS';
...
export const GET_ERRORS_DOCUMENTS = 'GET_ERRORS_DOCUMENTS';

export const GET_SECOURS = 'GET_SECOURS';
export const GET_SECOURSS = 'GET_SECOURSS';
export const ADD_SECOURS = 'ADD_SECOURS';
export const GET_ONE_SECOURS = 'GET_ONE_SECOURS';
export const DELETE_SECOURS = 'DELETE_SECOURS';
export const UPDATE_SECOURS = 'UPDATE_SECOURS';
export const SECOURS_LOADING = 'SECOURS_LOADING';
export const GET_ERRORS_SECOURS = 'GET_ERRORS_SECOURS';

export const GET_ALLERGIE = 'GET_ALLERGIE';
export const GET_ALLERGIES = 'GET_ALLERGIES';
export const ADD_ALLERGIE = 'ADD_ALLERGIE';
export const GET_ONE_ALLERGIE = 'GET_ONE_ALLERGIE';
export const DELETE_ALLERGIE = 'DELETE_ALLERGIE';
export const UPDATE_ALLERGIE = 'UPDATE_ALLERGIE';
export const ALLERGIE_LOADING = 'ALLERGIE_LOADING';
export const GET_ERRORS_ALLERGIE = 'GET_ERRORS_ALLERGIE';
...
export const GET_SANGUIN = 'GET_SANGUIN';
export const ADD_SANGUIN = 'ADD_SANGUIN';
export const GET_ONE_SANGUIN = 'GET_ONE_SANGUIN';
export const DELETE_SANGUIN = 'DELETE_SANGUIN';
export const UPDATE_SANGUIN = 'UPDATE_SANGUIN';
export const SANGUIN_LOADING = 'SANGUIN_LOADING';
export const GET_ERRORS_SANGUIN = 'GET_ERRORS_SANGUIN';
...
export const GET_ERRORS_CATEGORIE = 'GET_ERRORS_CATEGORIE';
